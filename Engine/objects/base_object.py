...
class engine_object:
    ...
    def __onEvent__(self, event_name, event_data) -> None: #can be used for any event as long as the object has a reference to it, e.g: 'KeyDown' as event name and 'D' as teh data, representing the D key being pressed
        pass
